...
echo myvox_autop(myvox_echo('user:changepassword:change_password_confirm'));


?>

<div class="myvox-field">
    <label for="register-password2"><?php echo myvox_echo('user:password:label'); ?>*</label>
    <div class="profile_manager_register_input_container">
        ...
        <span class="profile_manager_validate_icon fa-pulse hidden myvox-icon-spinner myvox-icon fa fa-spinner"></span>
    </div>
...
<div id="retype_password" class="myvox-field">
    <label for="register-password2"><?php echo myvox_echo('user:password2:label'); ?>*</label>
    <div class="profile_manager_register_input_container">
...
<div class="myvox-foot">
    ...
    echo myvox_view('input/submit', array(
        'value' => myvox_echo('changepassword')
    ));
    ?>
</div>
