...
<div class="myvox-module myvox-module-info">
    <div class="myvox-head"><h3><?php echo myvox_echo('password_extended:password_header'); ?></h3></div>
    <div class="myvox-body">
        <div class="myvox-field">
            <label for="myvox-field-ue2gm5"
                   class="myvox-field-label"><?php echo myvox_echo('password_extended:current_password'); ?></label>
            <input value="" autocapitalize="off" autocorrect="off" type="password" name="current_password"
                   id="current_password" class="myvox-input-password">
        </div>
        <div class="myvox-field">
            <label for="myvox-field-vts7sq"
                   class="myvox-field-label"><?php echo myvox_echo('password_extended:new_password'); ?></label>
            <input value="" autocapitalize="off" autocorrect="off" type="password" name="password" id="password"
                   maxlength="<?= ($setting['maxLength']=='yes') ? $password_max_lenght_value : '' ?>" class="myvox-input-password">
            <div id="pass-info">
            </div>
            <br>
            <div id="retype_password" class="myvox-field">
                <label for="myvox-field-8vleod"
                       class="myvox-field-label"><?php echo myvox_echo('password_extended:retype_password'); ?></label>
